...
{{-- <div class="container"> --}}
    {{-- <div class="row justify-content-center"> --}}
        ...
        {{-- <div class="col-lg-10 col-xl-9 card flex-row mx-auto px-0">
            ...
            <div class="card-body">
                <h4 class="title text-center mt-4 text-muted">New Member</h4>
                <h4 class="text-center mt-4 text-pink">Sign up to PhysX</h4>
                <h4 class="text-center mt-4 text-muted">Already a member?<a class="text-pink">Log In</a></h4>
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="col-md-5 mx-auto">
                        ...
                        <input id="birthyear" type="text" class="form-control" name="birthyear"  required autocomplete="birthyear" autofocus>
                        <i class="bi bi-badge-cc-fill"></i>
                    </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="d-flex col-md-12 justify-content-center align-items-center mt-">
