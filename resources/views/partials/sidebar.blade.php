  ...
  <body>
    <div class="d-flex wrapper">
      <div class="d-flex flex-column flex-shrink-0 bg-light position-fixed full-height-sidebar">
        ...
        <ul class="nav nav-pills nav-flush mt-5 flex-column text-center">
          <li class="nav-item">
            <a href="#" class="nav-link py-3 mt-5" aria-current="page" title="" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Home">
